...
export function AuthIllustration() {
    ...
    return (
        <div className="relative h-full w-full overflow-hidden bg-slate-950 flex items-center justify-center p-8 perspective-1000">
            ...
            {/* Glowing Orbs */}
            <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-primary/20 blur-[100px] rounded-full pointer-events-none animate-pulse [animation-duration:10s]" />
            <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-accent/20 blur-[100px] rounded-full pointer-events-none animate-pulse [animation-duration:8s]" />
